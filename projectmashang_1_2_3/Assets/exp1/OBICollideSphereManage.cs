...
public class OBICollideSphereManage : MonoBehaviour
{
    ...
    /// 这是怎么判断的？这难道virualBoundaryParticlesData里面存的不是边界粒子的信息吗？怎么根据边界粒子的信息就知道positions是否靠近边界粒子呢？
    /// </summary>
    ...
    void Start()
    {   //这里实现了流体粒子单体的创建（instantiate方法直接创造一个实例）
    ...
    void Update()
    {
        ...
        for(int i=0;i<positions.Length;i=i+5){ // 也可以i=i+2，有限数量下，雨露均沾
        ...
        // 03.设置位置.设置dictionary里，赋予流体粒子以设定的位置.
        foreach(int key in sphereActive.Keys){
